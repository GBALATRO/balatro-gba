...
extern u32 score;
extern enum BlindType current_blind;
...
extern void display_hands(int value);
extern void display_discards(int value);
...
extern void affine_background_load_palette(const u16* palette);
