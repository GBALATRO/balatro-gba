...
If an issue is assigned to someone it usually means it's already being worked on and it's probably best to avoid working on it but feel free to join the discussion in the issue if there's anything you have to add.

If you see an unassigned issue you want to work on, comment there that you want to work on it and we will assign it to you. It is recommended to discuss the planned implementation before opening a PR so it is approved before you fully commit to working on it.
